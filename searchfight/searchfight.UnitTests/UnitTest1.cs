...
namespace searchfight.UnitTests
{
    ...
    public class UnitTest1
    {
        ...
        public void Can_Execute()
        {
            ...
            foreach (var item in mockSearchEngine.Object.SearchEngines)
            {
                // Act
                ISearch search = new Search(item);
                search.Execute(".net", mockParameter.Object.Parameters, mockParameterType.Object.ParameterTypes);

                // Assert
                Assert.IsNotNull(search.results);
                Assert.IsTrue(search.results > 0);
            }
        ...
        public void Can_Mock_Execute()
        {
            ...
            {
                // Act
                mockSearch.Object.Execute(".net", null, null);

                // Assert
                Assert.IsNotNull(mockSearch.Object.results);
                Assert.IsTrue(mockSearch.Object.results > 0);
            }
